 ...
 *-----------------------------------------------------------------------*/
#define CONFIG_BOOTCOMMAND "sf probe 0;sf read 0x82000000 0x40000 0x140000;bootm 0x82000000"
#define CONFIG_BOOTDELAY	1
#define CONFIG_BOOTARGS "mem=42M console=ttyAMA0,115200 root=/dev/mtdblock2 rw noinitrd init=/linuxrc rootfstype=squashfs  mtdparts=hi_sfc:256K(boot),1280K(kernel),2M(rootfs),4160K(userfs),1280K(bak_kernel),2M(bak_rootfs),4160K(bak_userfs),64K(factory),1088K(mtd)"
