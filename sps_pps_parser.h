#ifndef sps_pps_parser_h__
#define sps_pps_parser_h__
...
{  
    ...
    unsigned int num_units_in_tick;           //0 u(32)   
    unsigned int time_scale;                 //0 u(32)   
...
void memcpy_sps_data(unsigned char *dst, unsigned char *src, int len); 
